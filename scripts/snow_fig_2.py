...
cmap = mpl.colors.LinearSegmentedColormap.from_list(
    ...
    colors=[
        (x[0]/255, x[1]/255, x[2]/255) for x in [
            (  0, 95,206), (  0,150,189), ( 57,195,255),
            (140,211,255), (198,255,222), (255,255,255),
            (255,255,156), (255,211, 66), (239,162,  0),
            (255,113, 57), (255, 47, 34)
        ]
    ],
    N=256
)
norm = mpl.colors.BoundaryNorm(cbar_ticks, cmap.N)
...
mesh_b = data_b.plot.contourf(
    ax=ax_b, add_colorbar=False, transform=data_crs, 
    cmap=cmap, norm=norm#vmin=-50, vmax=50,
)
...
ax_a.text(0.015, 0.59, 'days', fontsize=18, transform=ax_a.transAxes)
...
ax_b.text(0.015, 0.59, 'days', fontsize=18, transform=ax_b.transAxes)
...
plt.show()
#plt.savefig(data_root.parent / 'scratch' / 'test.png', dpi=dpi)
